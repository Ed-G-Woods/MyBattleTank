...
void UTankAimmingComponent::AimAtLog(FVector a)
{
	
	UE_LOG(LogTemp, Warning, TEXT("%s Aiming at %s from %s"), *(GetOwner()->GetName()),*(a.ToString()), *(Barrel->GetComponentLocation().ToString()));
}
